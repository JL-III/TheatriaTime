 ...
 *
 * <p>This event carries no payload by design: it is fired at the moment the
 * month rolls over, so the firing itself is the signal. See the
...
public class MonthChangeEvent extends Event {
    ...
    /**
     * Creates a new month-change event. TheatriaTime fires these; consuming
